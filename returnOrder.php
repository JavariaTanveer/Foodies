...
<section class="contact">
   ...
   <div class="row">
      ...
      <!-- <form action="" method="post">
         ...
         <textarea name="msg" class="box" required placeholder="Enter your issue why u want to return order? " maxlength="500" cols="30" rows="10"></textarea>
    ...
    <label for="msg" align="left">Enter Issue:<span class="required"></span></label>
    <textarea id="msg" name="msg" class="box" required placeholder="Enter your issue why you want to return the order?" maxlength="500" cols="30" rows="10"></textarea>
